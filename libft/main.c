...
/*   Updated: 2014/12/01 14:12:55 by mdubray          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				uf_test_strcpy(void)
{
	...
	{
		printf("\nus : %s, your : %s\n", strcpy(dest, "Hello foo"), ft_strcpy(dest, "Hello foo"));
		D_ERROR
	}
	...
	if (strcmp(dest, dest2) != 0)
	{
		printf("\nus : %s, your : %s\n", strcpy(dest2, "Hello foo"), ft_strcpy(dest2, "Hello foo"));
		D_ERROR
	}
	strcpy(dest, "Hello");
	...
	if (strcmp(dest, dest2) != 0)
	{
		printf("\nus : %s, your : %s\n", strcpy(dest2, "Hello"), ft_strcpy(dest2, "Hello"));
		D_ERROR
	}
	return (1);
}
